...
class TaxonConcept < ActiveRecord::Base
  ...
  has_many :synonym_relationships, -> { TaxonRelationship.synonym_types },
    :class_name => 'TaxonRelationship', :dependent => :destroy

  has_many :inverse_synonym_relationships, -> { TaxonRelationship.synonym_types },
  ...
  has_many :trade_name_relationships, -> { TaxonRelationship.trade_types },
    :class_name => 'TaxonRelationship', :dependent => :destroy

  has_many :inverse_trade_name_relationships, -> { TaxonRelationship.trade_types },
    :class_name => 'TaxonRelationship',
    :foreign_key => :other_taxon_concept_id, :dependent => :destroy
